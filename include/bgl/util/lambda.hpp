...
#define _BGL_IS_EMPTY_I(a0, a1, a2, a3) \
  _BGL_HAS_COMMA(_BGL_CAT5(_BGL_IS_EMPTY_CASE_, a0, a1, a2, a3))
...
#define _BGL_LAMBDA_ARGS_0(...) \
  _BGL_LAMBDA_0(_BGL_LAMBDA_I(_BGL_VARIADIC_SIZE(__VA_ARGS__))(__VA_ARGS__))
